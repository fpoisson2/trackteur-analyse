...
class Config(db.Model):  # type: ignore[name-defined]
    ...
    # Configuration de l'endpoint d'éphémérides (URL et jeton d'accès)
    ephemeris_url = db.Column(db.String, nullable=False, default="")
    ephemeris_token = db.Column(db.String, nullable=False, default="")
